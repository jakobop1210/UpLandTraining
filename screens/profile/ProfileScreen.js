  ...
  return (
    <LinearGradient
      ...
      <View style={styles.userInfoView}>
        ...
        <Text style={styles.userNameText}>Jakob Opland</Text>
      </View>
      <View style={styles.userOptionsView}>
        <ProfileOptionButton title="Edit profile" iconname="user" iconColor="#4c3228" iconViewColor="#a08679" iconType="FontAwesome" />
        <ProfileOptionButton title="My stats" iconname="stats-chart" iconColor="#1D2D44" iconViewColor="#748CAB" />
        <ProfileOptionButton title="Settings" iconname="settings" iconColor="#333333" iconViewColor="#989898" />
